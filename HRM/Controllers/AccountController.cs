...
namespace HRM.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, HttpPostedFileBase UploadedImage)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = model.Phone,DepartmentId=model.DepartmentId, ImageName=image,FirstName=model.FirstName,lastName=model.lastName,DateOfBirth=model.DateOfBirth,Address=model.Address,UniqueId=model.UniqueId};
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            return RedirectToAction("EmpAdmin", "Emp");
        }
